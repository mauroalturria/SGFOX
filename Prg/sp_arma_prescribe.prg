...
** 				va a lo ultimo.
				...
				mBajaAgre = mBajaAgre + alltrim(mdetalleins) + ' ' + iif( mwkagregad2.PA_dosis > 0 , alltrim(str(mwkagregad2.PA_dosis)),'') + ' ' + alltrim(mwkagregad2.PA_unidadvol) ;
					+ ' ' + iif( mwkagregad2.PA_cantpres > 0 , alltrim(str(mwkagregad2.PA_cantpres)), '') + ' ' + alltrim(mwkagregad2.PA_unipres) ;
					+ ' (Dosis '+ ALLTRIM(STR(mwkagregad2.PA_cantidad))+ ' ' + ALLTRIM(mwkagregad2.PA_unidadvol)+')';
					+ ' ' + alltrim(mwkagregad2.PA_comentarios) + chr(13)
