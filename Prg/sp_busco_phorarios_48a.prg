...
*		if mwkhcarchivo.id < 280716 OR  mwkhcarchivo.id> 280830 && esto es por si hay dos tandas de etiquetas
*	if mwkhcarchivo.id <      356257&&& poner aca el id que corresponda y sacarle el asterisco
		if morden # 9999				&&& poner asterisco en esta
			delete from medicos where afiliado = mnregistrac
		endif
&&	NO OLVIDARSE DE VOLVERLO A COLOCAR BIEN!!!!
	endif
