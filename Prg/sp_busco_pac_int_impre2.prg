...
mret = sqlexec(mcon1, "select PAC_nombrepaciente, PAC_codhce, PAC_codadmision, pac_categoria," + ;
	"paj_nropajarera, COB_codentidad as ent_codent, ENT_descrient,ENT_nroprestadorexterno, COB_codcontrato, " + ;
	"CON_descricont, AFI_nroafiliado, REG_tipodocumento, REG_numdocumento,sec_codsector , " + ;
	"PAC_fecnacimiento, PAC_edad, PAC_sexo, PAC_estadocivil, PAC_ocupacion,PAC_denuncia, " + ;
