...
Define Bar 1 Of menúcontex Prompt "RETENIDA";
	SKIP For lmenu(1)
Define Bar 2 Of menúcontex Prompt "PRESTAMO" ;
	SKIP For lmenu(2)
Define Bar 3 Of menúcontex Prompt "PARA FACTURACION" ;
	SKIP For lmenu(3)
Define Bar 4 Of menúcontex Prompt "DEVOLUCION A PISO" ;
	SKIP For lmenu(4)
...
Define Bar 8 Of menúcontex Prompt "RETENIDA POR LEGALES" ;
	SKIP For lmenu(8)
Define Bar 9 Of menúcontex Prompt "RECIBIDA EN LEGALES" ;
	SKIP For lmenu(9)
Define Bar 10 Of menúcontex Prompt "LIBERADA POR LEGALES" ;
	SKIP For lmenu(10)
Define Bar 11 Of menúcontex Prompt "PARA CGI" ;
	SKIP For lmenu(11)
Define Bar 12 Of menúcontex Prompt "RECIBIDO EN CGI" ;
	SKIP For lmenu(12)
Define Bar 13 Of menúcontex Prompt "PENDIENTE CGI" ;
	SKIP For lmenu(13)
