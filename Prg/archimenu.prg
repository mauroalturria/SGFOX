*       *********************************************************
*       *                                                         
*       * 04/11/2004           ARCHIMENU.MPR            10:50:48  
*       *                                                         
*       *********************************************************
*       *                                                         
*       * Nombre del autor                                        
...
DEFINE BAR 1 OF menucontex PROMPT "ARCHIVO" ;
	SKIP FOR lmenu(1)
DEFINE BAR 2 OF menucontex PROMPT "PREPARADA" ;
	SKIP FOR lmenu(2)
DEFINE BAR 3 OF menucontex PROMPT "DESPACHADA" ;
	SKIP FOR lmenu(3)
DEFINE BAR 4 OF menucontex PROMPT "CONSULTORIO" ;
	SKIP FOR lmenu(4)
DEFINE BAR 5 OF menucontex PROMPT "FALTANTE" ;
	SKIP FOR lmenu(5)
DEFINE BAR 6 OF menucontex PROMPT "SECTOR" ;
	SKIP FOR lmenu(6)
DEFINE BAR 7 OF menucontex PROMPT "NO CORRESPONDE" ;
	SKIP FOR lmenu(7)
DEFINE BAR 8 OF menucontex PROMPT "PENDIENTE" ;
	SKIP FOR lmenu(8)
DEFINE BAR 9 OF menucontex PROMPT "INTERNADO" ;
	SKIP FOR lmenu(9)
DEFINE BAR 10 OF menucontex PROMPT "ESPERA CONFIRM." ;
	SKIP FOR lmenu(10)
DEFINE BAR 11 OF menucontex PROMPT "IMPRIME ETIQUETA" ;
	SKIP FOR lmenu(11)
DEFINE BAR 12 OF menucontex PROMPT "SOLO EN HCE";
	SKIP FOR lmenu(11)
