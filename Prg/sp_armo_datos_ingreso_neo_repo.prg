...
If Used("mwkNeoIRespira")
	If Reccount("mwkNeoIRespira")>0
		...
		If Len(mIngresoR)>0
			mIngreso = mIngreso + Chr(13) + "- ASPECTO RESPIRATORIO:" + Chr(13) + mIngresoR
		Endif
...
If Used("mwkNeoICardio")
	If Reccount("mwkNeoICardio")>0
		...
		mCardio12 = Iif(Empty(mwkNeoICardio.car_otrasdrogas),"","Otras Drogas: " + Alltrim(Proper(mwkNeoICardio.car_otrasdrogas)) + Chr(13))
		mCardioa = Iif(mwkNeoICardio.car_sildena=1,"Sildenafil = Si " ,"")
		mCardiob = Iif(mwkNeoICardio.car_pge1=1,"PGE1 = Si ","")
		mCardioc = Iif(mwkNeoICardio.car_ino=1,"iNO = Si ","")
		mCardiod = Iif(mwkNeoICardio.car_indomet=1,"Indomet = Si ","")
		mCardioe = Iif(mwkNeoICardio.car_aas=1,"AAS = Si ","")
		mCardio = ""
...
If Used("mwkNeoIAbdomen")
	If Reccount("mwkNeoIAbdomen")>0
		...
		If Len(mAbdo1 + mAbdo2 + mAbdo3 + mAbdo4 + mAbdo5 + mAbdo6 + mAbdo7 + mAbdo8 + mAbdo9 )>0
