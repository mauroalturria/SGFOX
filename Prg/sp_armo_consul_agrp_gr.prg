...
If used('consul')
	If reccount('consul')>0
		Create cursor mwkconsag;
			...
			, h21 c(1), m21 c(1), h22 c(1), m22 c(1), h23 c(1),m23 c(1) , h24 c(1), m24 c(1);
			, hdes n(4), ft n(1) ;
		...
		Scan
			...
			For mi = 0 to 23
				...
				mvar    = &mvarh2
				&mvarh1 = nvl(mvar,' ')
				mvarh1  = "mm" + transf(mi,"@L 99")
				mvarh2  = "mwkcons01.m"+ transf(mi,"@L 99")
				mvar    = &mvarh2
				&mvarh1 = nvl(mvar,' ')
			Next mi
			Select mwkconsag
			...
			If !found()
				...
				m19, m20, m21,m22, m23, m24,h0a6, h22a24, porc ) ;
				values ;
				...
				mm19, mm20, mm21,mm22, mm23, mm24,mh0a6, mh22a24,	mporc )
			Else
				For mi = 0 to 24
