...
* Actualización 2022-07-26 - Agregado de Centro Médico Lima
...
If  Inlist(mwkTurnoid.codserv,1130)
	Return .F.
Endif
...
*	# Filtro prestaciones para Foniatría que son presenciales (JIRA GGP-2079) y Audiología (JIRA GGP-2142)
	...
	If !lcturnodistancia And Inlist(mwkTurnoid.codesp ,"FONI","AUDI")
		lpaso = .f.
	Endif
...
*		lclink = prg_tablinks("SGCURL2")
		...
		Else
			...
			lclink = lclink + '?v1=' + mv1 + '&v2=' + mv2 + '&v3=' + mv3 + '&v4=' + mv4 + '&v5=' + mv5 + '&v6=' + mv6 + '&v7=' + mv7 + '&v8=' + mv8 + '&v9=' + mv9 + '&v10=' + mv10 + '&tipv=' + mv11 + '&trato=' + lctrato + '&centro=' + Alltrim(Str(lncentrolima))
