****
**  Seteos del sistema - BRISTOL
****

public mcon1, midusu, mpassw, msql_reg, mcon3,mconc,myip,miform,mxambito  ,mxcentromedico,block_ent 
mxcentromedico=1
...
_Screen.Themes = .F.
_Screen.Icon = 'dmm.ico'
*****
mresplog = 0
public vec_vale(31,3), dat_vale(30), item_vale(61,3), dat_fac(22), ;
...
dime vec_vale(31,3), dat_vale(30), item_vale(61,3), dat_fac(22), ;
...
do form frmloguin1 with 'BRISTOL'
