...
public mcon4, mcon1, midusu, mpassw, mcodvax, msql_reg, mresplog,;
	mtfhoy,myip,miform,mcon3,xtremeoff,mxambito 
mxambito = 1
...
public vec_vale(31,3), dat_vale(30), item_vale(31,3), dat_fac(100),dat_facC(20), mversion, ;
		det_fac(200,8),msel_datos(20,4),dat_cose(40,20),item_cose(40,20),dat_busca(40,8),dat_ws(30),LCSQL
dime vec_vale(31,3), dat_vale(30), item_vale(31,3),  dat_fac(100),dat_facC(20), msel_datos(20,4);
