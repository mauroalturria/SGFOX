...
if type('mtitulo')#"C"
	mtitulo = "Registro de Ficha Epidemiológica"
ENDIF

nbar = 1
DEFINE POPUP menucontex SHORTCUT RELATIVE FROM MROW(),MCOL() title mtitulo
DEFINE BAR 1 OF menucontex PROMPT "POLITRAUMATIZADO " ;
	SKIP FOR lmenu(1)
DEFINE BAR 2 OF menucontex PROMPT "INFLUENZA  " ;
	SKIP FOR lmenu(2)
DEFINE BAR 3 OF menucontex PROMPT "ENFERMEDADES TRANSMITIDAS POR MOSQUITOS ";
	SKIP FOR lmenu(3)
DEFINE BAR 4 OF menucontex PROMPT "BRONQUIOLITIS " ;
	SKIP FOR lmenu(4)
DEFINE BAR 5 OF menucontex PROMPT "Visualiza o carga nueva ficha CORONAVIRUS" ;
	SKIP FOR lmenu(5)
DEFINE BAR 6 OF menucontex PROMPT "Modificacion Ficha CORONAVIRUS" ;
	SKIP FOR lmenu(6)
