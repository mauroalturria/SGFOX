...
* Módulo  : Farmacia ( Seteos del Sistema )
* Fecha   : 20-12-2007
* Observ. : Hereda del Proyecto ADMISION
****

Public mcon1, mcon1, mcon4, midusu,mconc,myip,miform,mxambito ,mxcentromedico,mconsql,lhabsqlserver 
mxcentromedico =1
mxambito  = 1
...
Public mtfhoy,vec_vale(31,3), dat_vale(30), item_vale(31,3), dat_fac(23), mversion, msel_datos(25,4),det_fac(40,8),dat_vale1(30),item_vale1(31,3)
Dime vec_vale(31,3), dat_vale(30), item_vale(31,3), dat_fac(23), msel_datos(25,4),det_fac(40,8),dat_vale1(30),item_vale1(31,3)
...
Do form frmloguin1 with 'PREPARADORES'
