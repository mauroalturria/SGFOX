*       *********************************************************
*       *                                                         
*       * 04/11/2004           PadronMENU.MPR            10:50:48  
*       *                                                         
*       *********************************************************
*       *                                                         
*       * Nombre del autor                                        
...
if type('mtitulo')#"C"
	mtitulo = "Seleccione Orden"
endif
DEFINE POPUP menucontex SHORTCUT RELATIVE FROM MROW(),MCOL() title mtitulo
DEFINE BAR 1 OF menucontex PROMPT "AFILIADO" ;
	SKIP FOR lmenu(1)
DEFINE BAR 2 OF menucontex PROMPT "APELLIDO" ;
	SKIP FOR lmenu(2)
DEFINE BAR 3 OF menucontex PROMPT "DOCUMENTO";
	SKIP FOR lmenu(3)
DEFINE BAR 4 OF menucontex PROMPT "CUIL" ;
	SKIP FOR lmenu(4)
...
*!*		SKIP FOR lmenu(7)
*!*	DEFINE BAR 8 OF menucontex PROMPT "VISUALIZA" ;
*!*		SKIP FOR lmenu(8)
*!*	DEFINE BAR 9 OF menucontex PROMPT "RECIBIDO" ;
*!*		SKIP FOR lmenu(9)
