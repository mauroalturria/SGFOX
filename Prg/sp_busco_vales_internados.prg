...
mret = sqlexec(mcon1, "select VAL_codvaleasist,VAL_fechasolicitud,VAL_horasolicitud,PIA_codprest,PAC_habitacion, PAC_cama,"+;
	...
	" from presinsuvas,valesasist ,pacinternad  " + ;
	...
	" where val_codservvale <> 5410 and  Presinsuvas.PIA_VALESASIST = Valesasist.VALESASIST and pacinternad.pin_codadmision = Valesasist.VAL_codadmision "+;&&and val_estado = 2  
