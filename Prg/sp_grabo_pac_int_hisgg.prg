...
do sp_conexion
mdesde = ctod("29/04/2009")
mhasta = ctod("30/04/2009")
create cursor camas (codadmisio c(8), habitacion c(4),cama c(2),dia d,SECT C(3))
If used('mwkpacint2')
	Use in mwkpacint2
Endif
				...
				If reccount('mwklugar')>0
					...
					Scan
						...
						For mndia = 1 to mveces
							...
							Endif
							mtipo = 2
							if inlist(msector ,'PED','TEP')
								xhab = mwklugar.LUG_habitacion
								xcam = mwklugar.LUG_cama
								
								insert into camas (codadmisio, habitacion ,cama ,dia,sect );
									values (mcda ,xhab,xcam,mdia,msector  )
							endif
...
*!*					xcam = mwklugar.LUG_cama
*!*					
*!*					insert into camas (codadmisio, habitacion ,cama ,dia );
*!*						values (mcda ,xhab,xcam,mndia )
*!*				endif
