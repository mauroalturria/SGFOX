Parameters registracion,idmedico,entidad,dni,idambula,cie,origen,cadmision

parametros = Transform(registracion) +  ' - ' + Transform(idmedico) + ' - ' + Transform(entidad) + ' - ' + Transform(dni) + ' - ' + Transform(idambula) + ' - ' + Transform(cie) + ' - ' + Transform(origen)

Strtofile(parametros,"recibo.txt")

* prg_llamo_receta_web
...
*!*		murl = "https://desa.sg.com.ar/intranet/lanzador/prog/wambdev/receta_visual.php" && Desarrollo
*!*	Case  (".50.110" $ mccon) && Desarrollo 50.110
*!*		murl = "https://desa.sg.com.ar/intranet/lanzador/prog/wambdev/receta_visual.php" && Desarrollo
*!*	Case  (".50.102" $ mccon) && QAS 50.102
*!*		murl = "https://profesionalqas.sg.com.ar/intranet/lanzador/prog/wamb/receta_visual.php" && Desarrollo
*!*	Otherwise  && Producción
*!*		murl = "https://profesional.sg.com.ar/intranet/lanzador/prog/wamb/receta_visual.php" && Producción
*!*	Endcase

lcSql = 'select * from tabestados where propietario = 57 and tipo = 30 and estado = 1'
...
lclink = murl + '?v1=' + mv1 + '&v2=' + mv2 + '&v3=' + mv3 + '&v4=' + mv4 + '&v5=' + mv5 + '&v6=' + mv6 + '&v7=' + mv7 + '&v8=' + mv8 + '&v9=' + mv9 + '&v10=' + mv10 + '&v11=' + mv11 + "&v12=" + mv12 + '&v13=' + mv13 + '&llamadesde=' + mv14 + '&dx=' + mv15 + '&centro=' + Alltrim(Str(lncentrolima)) + '&admision="' + Alltrim(ladmision) + '"'
lclink = Strtran(lclink,' ','%20')

Strtofile(lclink,"linkpisos2.txt")
