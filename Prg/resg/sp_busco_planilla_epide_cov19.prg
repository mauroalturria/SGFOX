...
*////////////////////////////////////
* Esto corre en VFP 6.0 . Revisar todo los Query para que funcionen (Sacar los TEXT TO )
...
If lnReturn < 0
   =Aerror(merror)
   * Messagebox(" Error de consulta para COVID19 " + Chr(10)+ Chr(10) + "AVISE A SISTEMAS",16,"ERROR")
...
Else
   ...
   *   TEXT TO lcCOMDContactos TEXTMERGE NOSHOW PRETEXT 7
   lcCOMDContactos = "SELECT Zabcov19contacto.CON_ApeNom , "+ ;
      ...
      "WHERE Zabcov19contacto.CON_Idplanilla = " + m.liIdplanillaCont
   ...
   *   ENDTEXT
   ...
   If lnReturn < 0
      * Messagebox("ERROR EN FICHAS DE EPIDEMIOLOGIA COVID-19 para contactos "+Chr(10)+ "AVISE A SISTEMAS",16,"ERROR")
