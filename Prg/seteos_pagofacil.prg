...
* Purpose....:  Seteos del sistema - Iniciliza la construccion de los archivos para Pago Facil
*
**********************************************************************
**
Lparameters miparam
...
With _Screen
   ...
   .Caption 	= '.:: Generación de Archivo para Enviar a Pago Facil ( Padrón OSUTHGRA )::.'    && título de la Ventana
   .Icon = 'class.ico'
   .Visible = .T.
   *-- Agregado para Identificar el sistema
   .AddObject ( "Title1", "Title" )
   .Title1.Caption = 'Proceso de Generacion de Archivos para Pago Facil ( Padrón OSUTHGRA )'
   .AddObject ( "Title2", "Title" )
   .Title2.Caption = 'Proceso de Generacion de Archivos para Pago Facil ( Padrón OSUTHGRA )'
...
ldFecha = Date()  							&& sp_busco_fecha_serv("DD")
On Error = Aerr(eros)

*///////////////////////////////////////////////////////////////////////////////////////
*-- Guardo el Inicio de la atividad al ejecutar
Strtofile( Replicate('/',100) +Chr(13)+Chr(10),"PagoFacil.LOG",1)
Strtofile( Dtoc( ldFecha )+" "+Time()+" - Inicio Reloj - Proceso Pago Facil " + Chr(13) + Chr(10),"PagoFacil.LOG",1)

 do form frmPagoFacilLaunch
 READ EVENTS
 
*--Instancio la clase para procesar el envio de Pago Facil 
*!*	oConsultaPagoFacil = Newobject("cGeneroPagoFacil", "...\sp_generopagofacil.prg")
*!*	oConsultaPagoFacil.GeneroDatosEnvio()


*!*	Wait Window At 20,20 Nowait "Proceso Terminado..." Timeout 30
Strtofile( Dtoc( ldFecha )+ " " + Time() + ' -  Fin Reloj - Proceso Pago Facil ' + Chr(13)+Chr(10),"PagoFacil.LOG",1 )
