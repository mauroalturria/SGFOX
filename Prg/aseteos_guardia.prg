...
public mcon4, mcon1, midusu, mpassw, mcodvax, msql_reg, mresplog,;
	mtfhoy,myip,miform,mcon3,xtremeoff,mxambito,LCSQL
mxambito = 1
...
public vec_vale(31,4), dat_vale(30), item_vale(31,3), dat_fac(100),dat_facC(20), mversion, msel_datos(25,4),;
	det_fac(200,8),xusuariologin,dat_cose(40,20),item_cose(40,20),dat_busca(40,8),dat_ws(30),seteos_public
dime vec_vale(31,4), dat_vale(30), item_vale(31,3), dat_fac(100), dat_facC(20),msel_datos(25,4),;
	det_fac(200,8),dat_cose(40,20),item_cose(40,20),dat_busca(40,8),dat_ws(30)
...
create cursor registra ;
	...
	cpostal n(4), locali c(25), pcia c(25), fecnac d, sexo c(1),email c(50))
...
mcantexe = 0
do prg_exes_activos with 'GUARDIA'
