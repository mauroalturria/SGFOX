...
DEFINE CLASS FTP_SERVICE AS custom
   ...
   ****************************************************
   PROCEDURE AutoDialInternet(lnType)
   ...
   ****************************************************
   PROCEDURE BeforeAutoDialInternet(lnType) && Raised before calling  API function InternetAutoDial()
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ENDPROC

   ****************************************************
   PROCEDURE AfterAutoDialInternet(lnType,fResult) && Raised after calling  API function InternetAutoDial()
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ENDPROC
   ...
   ****************************************************
   PROCEDURE AfterAutoDialHangUp(fResult) && Raised after calling  API function InternetAutoDialHangUp()
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ENDPROC
	  
   ****************************************************	
   PROCEDURE DialInternet(lcDialUpName, lnFlag) && Attempts to use a preconfigured Dial Up account to connect to the internet
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ...
   ****************************************************
   PROCEDURE BeforeDialInternet(lcDialUpName, lnFlag) && Raised before calling  API function InternetDial()
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ENDPROC

   ****************************************************
   PROCEDURE AfterDialInternet(lcDialUpName, lnFlag, lnConnectionID, fResult) && Raised after calling  API function InternetDial()
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ENDPROC
   ...
   ****************************************************
   PROCEDURE DialHangUp(lnConnectionID) && Closes a dialup connection
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
      LOCAL fResult
      IF This.LoadAPIFuncs() != ERROR_SUCCESS
   ...
   ****************************************************
   PROCEDURE BeforeDialHangUp(lnConnectionID) && Raised before calling  API function InternetHangUp()
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ENDPROC

   ****************************************************
   PROCEDURE AfterDialHangUp(lnConnectionID,fResult) && Raised after calling  API function InternetHangUp()
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ENDPROC
   ...
   ****************************************************
   PROCEDURE AfterGetConnectedState(fResult, lnConnectionState) && Raised after calling  API function InternetGetConnectedState()
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ENDPROC
   ...
   ****************************************************	
   PROCEDURE GoOnline(lcURL) && Brings up a dialog to the user requesting permission to go the requested URL
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
      LOCAL lnHWNDHandle, fResult
      IF This.LoadAPIFuncs() != ERROR_SUCCESS
   ...
   ****************************************************
   PROCEDURE BeforeGoOnline(lcURL) && Raised before calling  API function InternetGoOnline()
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ENDPROC

   ****************************************************
   PROCEDURE AfterGoOnline(lcURL, fResult) && Raised after before calling  API function InternetGoOnline()
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ENDPROC
   ...
   ****************************************************
   PROCEDURE OpenInternet(lcUserName, lcPassword,lcIPAddress, lcPort, lnFlag)
    ...
    && Attempts to open a connection to the FTP server
      ...
      **Marcelo Torres
      **Para que cuernos le agregan cNull?????
      This.cUserName = ALLTRIM(m.lcUserName)           && Store FTP Connection information
      This.cPassword = ALLTRIM(m.lcPassword)
      This.cIPAddress = ALLTRIM(m.lcIPAddress)
      ...
      **This.nInet_Handle = InternetOpen((This.cAgent), m.liAccessType, @m.lcProxyName, @m.lcProxyBypass,m.lnFlag)
      This.nInet_Handle = InternetOpen((This.cAgent), INTERNET_OPEN_TYPE_DIRECT, CHR(0), CHR(0),m.lnFlag)      		   	
   ...
   ****************************************************
   PROCEDURE OpenFTPConnection(lcCurrentFolder) && Connect to FTP server
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
      ...
      **                  (This.cUserName), (This.cPassword), INTERNET_SERVICE_FTP, This.nFlags, 0)
      lnConnect_Handle = InternetConnect(This.nInet_Handle, (This.cIPAddress), 0, ;
   ...
   ****************************************************
   PROCEDURE SetCachingMethod(nCachingType) && Changes the current file caching method
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ...
   ****************************************************
   PROCEDURE GetFTPFile(lcRemoteFile, lcLocalFile, llFailIfExists, lnFlag) && Get file from the FTP Server
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ...
   ****************************************************
   PROCEDURE BeforeGetFTPFile(lcRemoteFile, lcLocalFile, llFailIfExists, lnFlag) && Raised before calling  API function FtpGetFile()
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ENDPROC

   ****************************************************
   PROCEDURE AfterGetFTPFile(lcRemoteFile, lcLocalFile, llFailIfExists, lnFlag, fResult) && Raised after calling  API function FtpGetFile()
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ENDPROC
   ...
   ****************************************************
   PROCEDURE PutFTPFile(lcRemoteFile, lcLocalFile, lnFlag) && Sends a file to the FTP server from some local area
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
      LOCAL fResult
      IF EMPTY(m.lcRemoteFile)
      ...
      IF This.OpenFTPConnection(This.cCurrentDir)     && Open an FTP Handle
         ...
         fResult = FtpPutFile(This.nConnect_Handle, @m.lcLocalFile, @m.lcRemoteFile, ;
   ...
   ****************************************************
   PROCEDURE BeforePutFTPFile(lcRemoteFile, lclocalFile, lnFlag) && Raised before calling  API function FtpPutFile()
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ENDPROC

   ****************************************************
   PROCEDURE AfterPutFTPFile(lcRemoteFile, lclocalFile, lnFlag, fResult) && Raised after calling  API function FtpPutFile()
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ENDPROC
   ...
   ****************************************************
   PROCEDURE WriteFTPFile(lcRemoteFile, lcData,liData,liStart,liFlags,lnFlag) && Sends a file or string to the FTP server from some local area
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
...
*         lcData=SUBST(lcData,liStart+1)
   ...
   ****************************************************
   PROCEDURE BeforeWriteFTPFile(lcRemoteFile, lcData, liData, liStart, liFlags, lnFlag) && Raised before calling  API function FtpOpenFile()
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ENDPROC

   ****************************************************
   PROCEDURE AfterWriteFTPFile(lcRemoteFile, lcData,liData,liStart,liFlags, lnFlag, fResult) && Raised after last calling API InternetWriteFile()
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ENDPROC

   ****************************************************
   PROCEDURE AtWriteFTPFile(lcRemoteFile, lcData,liData,liStart,liFlags,lnFlag,lii,liWrite,fResult) && Raised after each calling  API function InternetWriteFile()
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ENDPROC
   ...
   ****************************************************
   PROCEDURE ReadFTPFile(lcRemoteFile,lcData,liData,liRStart,liLStart,liFlags,lnFlag) && Get file from FTP do string or local file
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ...
   ****************************************************
   PROCEDURE BeforeReadFTPFile(lcRemoteFile,lcData,liData,liRStart,liLStart,liFlags,lnFlag) && Raised before calling  API function FtpOpenFile()
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ENDPROC

   ****************************************************
   PROCEDURE AfterReadFTPFile(lcRemoteFile,lcData,liData,liRStart,liLStart,liFlags,lnFlag,fResult) && Raised after last calling API function InternetReadFile()
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ENDPROC

   ****************************************************
   PROCEDURE AtReadFTPFile(lcRemoteFile,lcData,liData,liRStart,liLStart,liFlags,lnFlag,lcBuffer,fResult) && Raised after calling API function InternetReadFile()
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ENDPROC
   ...
   ****************************************************
   PROTECTED PROCEDURE _FTPCommand(lcCommand,liFlags,liContext, lihFTP) && Send native FTP command to FTP server (iternal method)
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
      LOCAL fResult
   ...
   ****************************************************
   PROCEDURE FTPCommand(lcCommand,liFlags,liContext, lihFTP) && Send native FTP command to FTP server
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
      LOCAL fResult
      liFlags=IIF(PCOUNT()<2,FTP_TRANSFER_TYPE_BINARY,m.liFlags)
   ...
   ****************************************************
   PROCEDURE BeforeFTPCommand(lcCommand,liFlags,liContext,lihFTP) && Raised before calling  API function FtpCommand()
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ENDPROC

   ****************************************************
   PROCEDURE AfterFTPCommand(lcCommand,liFlags,liContext,lihFTP,fResult) && Raised after calling  API function FtpCommand()
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ENDPROC
   ...
   ****************************************************
   PROCEDURE DeleteFTPFile(lcRemoteFile) && Delete file on the FTP Server
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
      LOCAL fResult
      IF This.OpenFTPConnection(This.cCurrentDir)     && Open an FTP Handle
   ...
   ****************************************************
   PROCEDURE BeforeDeleteFTPFile(lcRemoteFile) && Raised before calling  API function FtpDeleteFile()
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ENDPROC

   ****************************************************
   PROCEDURE AfterDeleteFTPFile(lcRemoteFile,fResult) && Raised after calling  API function FtpDeleteFile()
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ENDPROC
   ...
   ****************************************************
   PROCEDURE RenameFTPFile(lcOldFile,lcNewFile) && Renames a file
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
      LOCAL fResult
      IF This.OpenFTPConnection(This.cCurrentDir)     && Open an FTP Handle
   ...
   ****************************************************
   PROCEDURE BeforeRenameFTPFile(lcOldFile,lcNewFile) && Raised before calling  API function FtpRenameFile()
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ENDPROC

   ****************************************************
   PROCEDURE AfterRenameFTPFile(lcOldFile,lcNewFile,fResult) && Raised after calling  API function FtpRenameFile()
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ENDPROC

   ****************************************************
   PROCEDURE GetFileSize(lcFile,  lnSize)  && Get File Size
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
      LOCAL lcPom,llRet
      IF This.OpenFTPConnection(This.cCurrentDir)     && Open an FTP Handle
   ...
   ****************************************************
   PROCEDURE BeforeGetFileSize(lcFile,  lnSize) && Raised before calling  API function FTPGetFileSize()
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ENDPROC

   ****************************************************
   PROCEDURE AfterGetFileSize(lcFile,  lnSize,llRet) && Raised after calling  API function FTPGetFileSize()
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ENDPROC
   ...
   ****************************************************
   PROCEDURE CreateFTPDirectory(lcNewDir) && Creates a directory on the FTP Server
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
      LOCAL fResult
      IF This.OpenFTPConnection(This.cCurrentDir)     && Open an FTP Handle  	   		
   ...
   ****************************************************
   PROCEDURE BeforeCreateFTPDirectory(lcNewDir) && Raised before calling  API function FtpCreateDirectory()
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ENDPROC

   ****************************************************
   PROCEDURE AfterCreateFTPDirectory(lcNewDir,fResult) && Raised after calling  API function FtpCreateDirectory()
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ...
   ****************************************************
   PROCEDURE RemoveFTPDirectory(lcDir) && Removes a directory on the FTP Server
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
      LOCAL fResult
      IF This.OpenFTPConnection(This.cCurrentDir)     && Open an FTP Handle  	   		  
   ...
   ****************************************************
   PROCEDURE BeforeRemoveFTPDirectory(lcDir) && Raised before calling  API function FtpRemoveDirectory()
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ENDPROC

   ****************************************************
   PROCEDURE AfterRemoveFTPDirectory(lcDir,fResult) && Raised after calling API function FtpRemoveDirectory()
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ENDPROC
			 
   ****************************************************
   PROCEDURE ChangeFTPDirectory(lcNewDir) && Change the current directory on the FTP Server
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ...
   ****************************************************
   PROCEDURE BeforeChangeFTPDirectory(lcNewDir) && Raised before calling  API function FtpSetCurrentDirectory()
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ENDPROC

   ****************************************************
   PROCEDURE AfterChangeFTPDirectory(lcNewDir,fResult) && Raised after calling API function FtpSetCurrentDirectory()
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ENDPROC
	  	
   ****************************************************
   PROCEDURE GetFTPDirectory( lcDirectory) && Get current directory on the FTP Server
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ...
   ****************************************************
   PROCEDURE BeforeGetFTPDirectory(lcDirectory) && Raised before calling  API function FtpGetCurrentDirectory()
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ENDPROC

   ****************************************************
   PROCEDURE AfterGetFTPDirectory(lcDirectory,fResult) && Raised after calling API function FtpGetCurrentDirectory()
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ENDPROC
   ...
   ****************************************************
   PROCEDURE GetFTPDirectoryArray( laDirectory, lcMask,lnFlag,  liCount) && Get a list of files from the current directory on the FTP Server
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ...
   ****************************************************
   PROCEDURE BeforeGetFTPDirectoryArray( laDirectory, lcMask, lnFlag) && Raised before calling API function FtpFindFirstFile()
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ENDPROC

   ****************************************************
   PROCEDURE AfterGetFTPDirectoryArray( laDirectory,lcMask, lnFlag,liResult) && Raised after last calling API function FtpFindNextFile()
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ENDPROC

   ****************************************************
   PROCEDURE List( luData, lcMask,liFlags,lnFlag) && Get a list of files and folders from the current directory on the FTP Server
      *!*   <pdm_sc_yes/>
      *!*   <pdm_dd_yes/>
   ...
   ****************************************************
   PROCEDURE BeforeList( luData, lcMask,liFlags,lnFlag) && Raised before calling API function FtpCommand
      *!*   <pdm_sc_yes/>
      *!*   <pdm_dd_yes/>
   ENDPROC

   ****************************************************
   PROCEDURE AfterList( luData, lcMask,liFlags,lnFlag,liResult) && Raised after closing FTP connection
      *!*   <pdm_sc_yes/>
      *!*   <pdm_dd_yes/>
   ENDPROC

   ****************************************************
   PROCEDURE AtList( luData, lcMask,liFlags,lnFlag, lcBuffer,liResult) && Raised after reading data from buffer
      *!*   <pdm_sc_yes/>
      *!*   <pdm_dd_yes/>
   ENDPROC

   ****************************************************
   PROCEDURE NLST( luData, lcMask,liFlags,lnFlag) && Get a list of files and folders from the current directory on the FTP Server
      *!*   <pdm_sc_yes/>
      *!*   <pdm_dd_yes/>
      EXTERNAL ARRAY luData
      LOCAL liResult, lihFTP,lii,lcBuffer,lcData,liData,liEnd,liCount,llRet
   ...
   ****************************************************
   PROCEDURE BeforeNLST( luData, lcMask,liFlags,lnFlag) && Raised before calling API function FtpCommand
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ENDPROC

   ****************************************************
   PROCEDURE AfterNLST( luData, lcMask,liFlags,lnFlag,liResult) && Raised after closing FTP connection
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ENDPROC

   ****************************************************
   PROCEDURE AtNLST( luData, lcMask,liFlags,lnFlag, lcBuffer,liResult) && Raised after reading data from buffer
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ENDPROC
   ...
   ****************************************************
   PROCEDURE BeforeReadTree(lcFolder, llChild, lcAlias) && Raised before calling API function FtpSetCurrentDirectory()
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ENDPROC

   ****************************************************
   PROCEDURE AfterReadTree(lcFolder, llChild, lcAlias,llNext) && Raised after calling API function FtpSetCurrentDirectory()
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ENDPROC
	  	
   ****************************************************
   PROCEDURE ReadTree(lcFolder, llChild, lcAlias) && Read Tree (folders and files)
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ...
   ****************************************************
   PROTECTED PROCEDURE CrackFile(lcString,  laDirectory) && Parsing file's attributes and storing to array
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
...
*!*	} FILETIME, *PFILETIME; 
   ...
   ****************************************************
   PROTECTED PROCEDURE CrackDate(lcOutBuffer) && Converting file system structure to system date
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ...
   ****************************************************
   PROTECTED PROCEDURE CrackAttributes(lcBuffer) && Converting file's attributes to human's format
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
   ...
   ****************************************************
   PROCEDURE GetErrorCode(llShowMessage) && Watch dog of this FTP Service
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
      LOCAL lcMessage
      IF m.llShowMessage
   ...
   ****************************************************
   PROCEDURE GetErrorText(lnError) && Get error text
      *!*	<pdm_sc_yes/>
      *!*	<pdm_dd_yes/>
      LOCAL lcMessage
      DO CASE
   ...
   ****************************************************
   PROTECTED PROCEDURE GetSystemOption(liOption) && Return any system option
      *!*   <pdm_sc_yes/>
      *!*   <pdm_dd_yes/>
...
*!*       /* "-rwxrwxrwx   1 noone    nogroup           322 Aug 19  1996 message.ftp" */
   ...
   PROCEDURE Parse( laFiles,loEngine)
      *!*   <pdm_sc_yes/>
      *!*   <pdm_dd_yes/>
...
DEFINE CLASS _LIST_PARSER_ENGINE AS _LIST_PARSER
   ...
   PROCEDURE Parse( laFiles,lcData)
      *!*   <pdm_sc_yes/>
      *!*   <pdm_dd_yes/>
