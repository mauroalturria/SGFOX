...
Public msql_reg,mcon1, mcon1, mcon4, midusu,mconc,myip
...
public mtfhoy,vec_vale(31,3), dat_vale(25), item_vale(31,3), dat_fac(23), mversion, msel_datos(25,4),det_fac(40,8),mxambito  ,mxcentromedico
mxcentromedico=1
mxambito = 1

dime vec_vale(31,3), dat_vale(25), item_vale(31,3), dat_fac(23), msel_datos(25,4),det_fac(40,8)
...
*if mresplog = 0
	...
	do form frmagenda_tel
	do sp_desconexion with "AGENDA"
*	do padmenu.mpr
	read events
