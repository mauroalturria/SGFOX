...
public mtfhoy,vec_vale(31,3), dat_vale(30), item_vale(151,3), dat_fac(23), mversion, msel_datos(25,4),det_fac(40,8)
dime vec_vale(31,3), dat_vale(30), item_vale(151,3), dat_fac(23), msel_datos(25,4),det_fac(40,8)
set ansi on
set bell off
set cent on
set compatible off
...
mresplog = 0
modify windows screen title "ARCHIVO"
...
do form frmloguin1 with 'ARCHIVO'
