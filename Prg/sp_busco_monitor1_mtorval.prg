...
create cursor VapHead1 ;
	( TipoReg N(1,0), Pun N(8,0), NroVale N(8,0), SeqVerif N(3,0), SqMae N(3,0), ;
		...
		HoraSolic C(5,0), Urgencia N(1,0), IdOperador N(5,0), NomOperador C(40), IdPrstdor C(40), ;
...
create cursor VapPres3 ;
	( TipoReg N(1,0), CodPrest N(10,0), DescPrest C(40), Cantidad N(4,0),MarcaEsp C(1),codlado c(40) )

*  cursor VAPINSU4  = Insumos principales (tipo 4) (vales de Farmacia)
create cursor VapInsu4 ;
	( TipoReg N(1,0), CodInsumo C(15), DescInsumo C(50), Cantidad N(4,0) )
