*       *********************************************************
*       *                                                         
*       * 04/11/2004           NUTRIMENU.MPR            10:50:48  
*       *                                                         
*       *********************************************************
*       *                                                         
*       * Nombre del autor                                        
...
DEFINE BAR 1 OF menucontex PROMPT "ALMUERZO" ;
	SKIP FOR lmenu(1)
DEFINE BAR 2 OF menucontex PROMPT "CENA" ;
	SKIP FOR lmenu(2)
DEFINE BAR 3 OF menucontex PROMPT "DESAYUNO" ;
	SKIP FOR lmenu(3)
DEFINE BAR 4 OF menucontex PROMPT "MERIENDA" ;
	SKIP FOR lmenu(4)
DEFINE BAR 5 OF menucontex PROMPT "COLAC.10 HS" ;
	SKIP FOR lmenu(5)
DEFINE BAR 6 OF menucontex PROMPT "COLAC.18 HS" ;
	SKIP FOR lmenu(6)
DEFINE BAR 7 OF menucontex PROMPT "ANAMNESIS" ;
	SKIP FOR lmenu(7)
DEFINE BAR 8 OF menucontex PROMPT "ANTERIORES" ;
	SKIP FOR lmenu(8)
DEFINE BAR 9 OF menucontex PROMPT "DETALLE" ;
	SKIP FOR lmenu(9)
DEFINE BAR 10 OF menucontex PROMPT "RECUPERA DE RESGUARDO" ;
	SKIP FOR lmenu(10)
