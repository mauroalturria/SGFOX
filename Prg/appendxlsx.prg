...
FUNCTION AppendFromExcel(tcXLSFile, tcSheet, tvWorkarea, tcExcelFieldList, tcExcelWhereExpr, tcTableFieldList, tcTableForExpr, tlNoHeaderRow)
	...
	**********************************
	...
	TRY
		...
		if Upper(Justext(m.tcXLSFile)) = "XLS"
			m.lnSQL = SQLSTRINGCONNECT([Provider=Microsoft.ACE.OLEDB.12.0;Data Source="] + m.tcXLSFile + [";Extended Properties="Excel 8.0 Xml;HDR=] + m.lcHeaderRow + [;";])
		Else
			...
			If m.lnSQL < 0
				m.lnSQL = SQLSTRINGCONNECT([Provider=Microsoft.ACE.OLEDB.12.0;Data Source="] + m.tcXLSFile + [";Extended Properties="Excel 14.0 Xml;HDR=] + m.lcHeaderRow + [;";])
			Endif 	
		Endif 
