mfecha = ctod("10/04/2013")-1
set step on
for yy=1 to 1
	cfiles="turnos_"+transf(yy+9,"@L 99")+"_04.dbf"
	cfilexls = "turno_"+transf(yy+9,"@L 99")+"04"
	if file(cfiles)
		mifecha = mfecha+yy
				...
				if reccount('turnos_telc')= 0
					...
					if reccount('turnos_telid')= 0
						...
						replace apeynom with turnos_telid.REG_nombrepac;
							...
							, codent with turnos_telid.codent,estado with "REP"+dtoc(turnos_telid.fechatur);
