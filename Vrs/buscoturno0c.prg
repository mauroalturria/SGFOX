...
*elect hcli0c
mfecan = ctod("01/02/2010")
mfechas = ctod("31/07/2012")
...
&&  *	"turnos.fechatur <  medpresta.fecvigenh and "
	...
	Select * from mwkphorario3 where fechatur <= mfechas;
		union all ;
	Select * from mwkphorario1 where fechatur <= mfechas;
		union all ;
		...
		from mwkphorario5 where fechatur <= mfechas;
