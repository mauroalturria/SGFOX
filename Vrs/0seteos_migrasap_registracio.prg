...
lcDir = "c:\SAP\IS-H\"
lcArc = "01_FORMATO_MCARGUE_DICCIONARIO_Pacientes.xlsx"
lbProcesar = .T.
...
Scan
	...
	lnReg1 = Alltrim(hclin)
*lnReg1 =   3769043
	mret = SQLExec(mcon1,"SELECT * FROM REGISTRACIO where reg_nrohclinica = ?lnReg1 ","MWKREGI")
	If mret <=0
		Set Step On
	Endif

	m1 = MWKREGI.registracio
	Select HC_PI_ISH
...
&& Nro celular
	...
	m17 = Iif(Alltrim(MWKREGI.reg_email)=="NO TIENE","",Alltrim(MWKREGI.reg_email))
	m18 = EstadoCivil()
	m19 = Religion()
	m20 = 'ES' && Idioma ?
